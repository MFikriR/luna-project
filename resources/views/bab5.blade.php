        ...
        <div class="main-content w-100 p-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Bab 5: Self-Description</li>
                </ol>
            </nav>

            <!-- Content -->
            <h2>Bab 5: Self-Description</h2>
            <!-- Content bab 5 goes here -->
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="{{ route('bab4') }}" class="btn btn-secondary">Kembali ke Bab Sebelumnya</a>
