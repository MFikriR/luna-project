        ...
        <div class="main-content w-100 p-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Bab 3: Self-Description</li>
                </ol>
            </nav>

            <!-- Content -->
            <h2>Bab 3: Self-Description</h2>
            <!-- Content bab 3 goes here -->
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="{{ route('bab2') }}" class="btn btn-secondary">Kembali ke Bab Sebelumnya</a>
                <a href="{{ route('bab4') }}" class="btn btn-primary">Next</a> 
            </div>
        </div>
    </div>
